...
class GarageFloorMapMotorist extends StatefulWidget {

  GarageFloorMapMotorist({super.key, required this.garage_id, required this.floor_no});
  String garage_id;
  String floor_no;

  @override
  State<GarageFloorMapMotorist> createState() => _GarageFloorMapMotoristState();
}

class _GarageFloorMapMotoristState extends State<GarageFloorMapMotorist> with TickerProviderStateMixin{
  Timer? _timer;
  ...
  Future <List<FloorMap>> getFloorMap() async{
    ...
    var res = await client.get(Uri.https("creativeparkingsolutions.com", "motorist/garage_floor_map_app/${widget.garage_id}/${widget.floor_no}"));
    ...
    var floorData = jsonData['floorData'];

    map_image = floorData['map_image'];
    ...
    for(var jsonFloor in jsonData['virtualData']){
      ...
      var isBook= jsonFloor['isBook'].toString();
      var isPark= jsonFloor['isPark'].toString();
      
      FloorMap floorMap = FloorMap(pos_x, pos_y, hight, width, parking_no, isBook, isPark);
...
class RectPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    floorMap.forEach((element) {
      ...
      var isPark = element.isPark;
      var isBook = element.isBook;
...
class FloorMap{
  ...
  FloorMap(this.pos_x, this.pos_y, this.height, this.width, this.parking_no, this.isBook, this.isPark);
