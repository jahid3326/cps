...
class NewPermitMotorist extends StatefulWidget {
  const NewPermitMotorist({super.key});

  @override
  State<NewPermitMotorist> createState() => _NewPermitMotoristState();
}

class _NewPermitMotoristState extends State<NewPermitMotorist> {
  Timer? _timer;
