import 'dart:async';
import 'dart:convert';
import 'package:cps/pages/admin/garage_map.dart';
...
class ManagementAdmin extends StatefulWidget {
  const ManagementAdmin({super.key});

  @override
  State<ManagementAdmin> createState() => _ManagementAdminState();
}

class _ManagementAdminState extends State<ManagementAdmin> {
  Timer? _timer;
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              ...
                                              Expanded(
                                                ...
                                                ElevatedButton(
                                                  onPressed: (){
                                                    Navigator.push(context, MaterialPageRoute(builder: (context)=>GarageMapAdmin(garage_id: garage.garage_id.toString())));
                                                  },
...
class TableList {
  ...
  TableList({this.id, this.garage_id, this.garage_name, this.location, this.status});
