...
class TrashGarageAdmin extends StatefulWidget {
  const TrashGarageAdmin({super.key});

  @override
  State<TrashGarageAdmin> createState() => _TrashGarageAdminState();
}

class _TrashGarageAdminState extends State<TrashGarageAdmin> {
  Timer? _timer;
  ...
  Future<dynamic> generateTableList() async {
    ...
    try {
      ...
      var res = await client.get(Uri.https('creativeparkingsolutions.com', 'garage/trash_garage_app'));
                                            ...
                                            children: [
                                                          ...
                                                          actions: [
                                                            ...
                                                            TextButton(
                                                              onPressed: () async{
                                                                ...
                                                                var res = await client.get(Uri.https('creativeparkingsolutions.com', 'admin/delete_trash_garage_app/${garage.id.toString()}'));
                                              ...
                                              Expanded(
                                                ...
                                                ElevatedButton(
                                                            ...
                                                            child: Container(
                                                              ...
                                                              child: Column(
                                                                children: [
                                                                  ...
                                                                  const Text("Do you want to restore this ?", style: TextStyle(color: Colors.grey),)
                                                                ],
                                                              ),
                                                            )
                                                          ),
                                                          actions: [
                                                            ...
                                                            TextButton(
                                                              onPressed: () async{
                                                                ...
                                                                var res = await client.get(Uri.https('creativeparkingsolutions.com', 'garage/restore_garage_app/${garage.id.toString()}'));
                                                                ...
                                                                if(res.statusCode == 200){
                                                                  ...
                                                                  if(jsonData['action'] == 'success'){
                                                                    ...
                                                                    EasyLoading.instance
                                                                      ...
                                                                      ..indicatorColor = Colors.green.shade900
                                                                      ..textColor = Colors.green.shade900;
                                                                    EasyLoading.showSuccess('Restore Success!');
                                                                    EasyLoading.dismiss();
                                                                    ...
                                                                    EasyLoading.instance
                                                                      ...
                                                                      ..indicatorColor = Colors.red.shade900
                                                                      ..textColor = Colors.red.shade900;
                                                                    EasyLoading.showError('Restore Failed!');
                                                                    EasyLoading.dismiss();
                                                                  }
                                                  ...
                                                  child: Icon(Icons.restart_alt_outlined, size: 25, color: Colors.green,),
                                                  style: ElevatedButton.styleFrom(
                                                    backgroundColor: Colors.transparent,
                                                    elevation: 0,
                                                    side: const BorderSide(
