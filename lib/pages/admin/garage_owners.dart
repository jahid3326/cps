...
class GarageOwnersAdmin extends StatefulWidget {
  const GarageOwnersAdmin({super.key});

  @override
  State<GarageOwnersAdmin> createState() => _GarageOwnersAdminState();
}

class _GarageOwnersAdminState extends State<GarageOwnersAdmin> {
  Timer? _timer;
  ...
  Future<dynamic> generateTableList() async {
    ...
    try {
      ...
      var res = await client.get(Uri.https('creativeparkingsolutions.com', 'admin/garage_owners_app'));
                                                          ...
                                                          actions: [
                                                            ...
                                                            TextButton(
                                                              onPressed: () async{
                                                                ...
                                                                var res = await client.get(Uri.https('creativeparkingsolutions.com', 'admin/delete_garage_owner_app/${data.id.toString()}'));
