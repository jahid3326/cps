...
class AddNewClientAdmin extends StatefulWidget {
  const AddNewClientAdmin({super.key});

  @override
  State<AddNewClientAdmin> createState() => _AddNewClientAdminState();
}

class _AddNewClientAdminState extends State<AddNewClientAdmin> {
  Timer? _timer;
  ...
  Future<void> add_new_client()async{
    ...
    try {
      ...
      var res = await client.post(Uri.https('creativeparkingsolutions.com', 'admin/add_new_client_app'), body: {
                    ...
                    delegate: SliverChildListDelegate(
                      [
                        Container(
                          ...
                          Column(
                            children: [
                              Text("Add New Client", style: TextStyle(fontSize: 20, color: Colors.black54, fontWeight: FontWeight.bold),),
                              SizedBox(height: 5,),
                              Form(
                                key: _formKey,
                                child: 
