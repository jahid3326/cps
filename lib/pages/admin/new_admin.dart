...
class _NewAdminState extends State<NewAdmin> {
  ...
  var selectedRoleValue = 'Choose Role';
  
  List _role_list = ['Super Admin', 'Modertor', 'IT Specilist', 'Editor'];
  ...
  Future<void> add_manager()async{
    ...
    try {
      ...
      var res = await client.post(Uri.https('creativeparkingsolutions.com', 'admin/new_admin_app'), body: {
          'user_type' : selectedRoleValue,
                    ...
                    delegate: SliverChildListDelegate(
                      [
                        Container(
                          ...
                          Column(
                            children: [
                              Text("New Admin", style: TextStyle(fontSize: 20, color: Colors.black54, fontWeight: FontWeight.bold),),
                              SizedBox(height: 5,),
                              Form(
                                key: _formKey,
                                child: 
