import 'dart:async';
import 'dart:convert';
import 'package:cps/pages/admin/add_manager.dart';
import 'package:cps/pages/admin/notifications.dart';
import 'package:cps/pages/admin/update_manager.dart';
...
class ManagersAdmin extends StatefulWidget {
  const ManagersAdmin({super.key});

  @override
  State<ManagersAdmin> createState() => _ManagersAdminState();
}
                      ...
                      ElevatedButton(
                        onPressed: (){
                          Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(builder: (context)=>NewManagerAdmin())
                          );
                        },
                        child: Row(
                          children: [
                                            ...
                                            children: [
                                              ...
                                              Expanded(
                                                ...
                                                ElevatedButton(
                                                  onPressed: (){
                                                    // print(data.id);
                                                    Navigator.push(context, MaterialPageRoute(builder: (context)=>UpdateManagerAdmin(id: data.id.toString())));
                                                  },
