...
class AddGarageFormAAdmin extends StatefulWidget {
  const AddGarageFormAAdmin({super.key});

  @override
  State<AddGarageFormAAdmin> createState() => _AddGarageFormAAdminState();
}

class _AddGarageFormAAdminState extends State<AddGarageFormAAdmin> {
  Timer? _timer;
  ...
  TextEditingController client_first_name = TextEditingController();
  TextEditingController client_last_name = TextEditingController();
  ...
  var selectedClientFirstNameValue = 'Choose client first name';
  List _client_first_name = ['Mr.', 'Mss.'];

  var selectedStateValue = "Choose State";
  var selectedCityValue = "Choose City";

  //////// Garage Dropdown List ////////////
  var selectedGarageValue = 'Choose Garage Owner';
  ...
  Future<dynamic> garageList() async {
    ...
    try {
      ...
      var res = await client.get(Uri.https('creativeparkingsolutions.com', 'admin/get_dropdown_garage_owner_app'));
      ...
      for(var jsonData in list){
        garage_list.add(jsonData['garage_owner_id']);
      }
                    ...
                    delegate: SliverChildListDelegate(
                      [
                        Container(
                          ...
                          Column(
                            children: [
                              Text("Add Garage Form A", style: TextStyle(fontSize: 20, color: Colors.black54, fontWeight: FontWeight.bold),),
                              SizedBox(height: 5,),
                              Form(
                                key: _formKey,
                                child: 
                                  ...
                                  children: [
                                    ...
                                    DecoratedBox(
                                      ...
                                      child:Padding(
                                        ...
                                        DropdownWithSearch(
                                          title: 'Garage Owner',
                                          placeHolder: 'Search Garage Owner',
                                          items: _garage_list,
                                    ...
                                    */
                                    Container(
                                      child: TextFormField(
                                        ...
                                        decoration: ThemeHelper().textInputDecoration('Client first name', 'Client first name'),
                                        validator: (val) {
                                          if(val!.trim().isEmpty){
                                    ...
                                    Container(
                                      child: TextFormField(
                                        controller: client_last_name,
                                        decoration: ThemeHelper().textInputDecoration('Client last name', 'Client last name'),
                                        validator: (val) {
                                          if(val!.trim().isEmpty){
                                    ...
                                    Container(
                                      child: TextFormField(
                                        controller: phone_no,
                                        decoration: ThemeHelper().textInputDecoration('Phone No', 'Phone No'),
                                        validator: (val) {
                                          if(val!.trim().isEmpty){
                                    ...
                                    Container(
                                      child: TextFormField(
                                        controller: zip,
                                        decoration: ThemeHelper().textInputDecoration('Zip', 'Zip'),
                                        validator: (val) {
                                          if(val!.trim().isEmpty){
