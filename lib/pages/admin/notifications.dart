...
class _NotificationAdminState extends State<NotificationAdmin> {
  ...
  Future <List<Notifications>> getAllNotification() async{
    ...
    var res = await client.get(Uri.https("creativeparkingsolutions.com", "admin/view_notification_app"));
                      ...
                      child: Column(
                        children: [
                          Expanded(
                            ...
                            //                       // Navigator.push(
                            //                       //   context,
                            //                       //   MaterialPageRoute(builder: (context)=>FloorsGarage(garage_id: garage.garage_id, garage_name: garage.garage_name))
                            //                       // );
                            //                     },
                            //                   ),
                            //                   SizedBox(height: 5,),
