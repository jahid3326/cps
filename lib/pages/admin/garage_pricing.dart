import 'dart:async';
import 'dart:convert';
import 'package:cps/pages/admin/add_new_pricing.dart';
...
class GaragePricingAdmin extends StatefulWidget {
  const GaragePricingAdmin({super.key});

  @override
  State<GaragePricingAdmin> createState() => _GaragePricingAdminState();
}

class _GaragePricingAdminState extends State<GaragePricingAdmin> {
  Timer? _timer;
                      ...
                      ElevatedButton(
                        onPressed: (){
                          Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(builder: (context)=>NewPricingAdmin())
                          );
                        },
                        child: Row(
                          children: [
