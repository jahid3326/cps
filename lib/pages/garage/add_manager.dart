...
class NewManagerGarage extends StatefulWidget {
  const NewManagerGarage({super.key});

  @override
  State<NewManagerGarage> createState() => _NewManagerGarageState();
}

class _NewManagerGarageState extends State<NewManagerGarage> {
  Timer? _timer;
