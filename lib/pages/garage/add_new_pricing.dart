...
class NewPricingGarage extends StatefulWidget {
  const NewPricingGarage({super.key});

  @override
  State<NewPricingGarage> createState() => _NewPricingGarageState();
}

class _NewPricingGarageState extends State<NewPricingGarage> {
  Timer? _timer;
