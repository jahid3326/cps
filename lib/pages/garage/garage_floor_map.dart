...
class GarageFloorMapGarage extends StatefulWidget {

  GarageFloorMapGarage({super.key, required this.garage_id, required this.floor_no});
  String garage_id;
  String floor_no;

  @override
  State<GarageFloorMapGarage> createState() => _GarageFloorMapGarageState();
}

class _GarageFloorMapGarageState extends State<GarageFloorMapGarage> with TickerProviderStateMixin{
  Timer? _timer;
                                ...
                                itemBuilder: (context, index){
                                  return Container(
                                    child: GestureDetector(
                                      ...
                                      onTap: () {
                                        Navigator.push(context, MaterialPageRoute(builder: (context)=> GarageFloorMapGarage(garage_id: widget.garage_id, floor_no: snapshot.data[index])));
                                      },
                                    )
                                  );
                                }
