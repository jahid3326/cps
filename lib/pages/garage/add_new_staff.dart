...
class AddNewStaffGarage extends StatefulWidget {
  const AddNewStaffGarage({super.key});

  @override
  State<AddNewStaffGarage> createState() => _AddNewStaffGarageState();
}

class _AddNewStaffGarageState extends State<AddNewStaffGarage> {
  Timer? _timer;
